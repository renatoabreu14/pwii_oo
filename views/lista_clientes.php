...
$lista = ControllerCliente::buscarTodos();
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col2">
                    <a href="cad_cliente.php" class="btn btn-success">Novo</a>
                </div>
                <br>
                    ...
                    <tbody>
                        <?php
                            foreach ($lista as $cliente){
                                echo "<tr>";
                                echo "<td width=\"40%\">".utf8_decode($cliente->getNome())."</td>";
                                echo "<td width=\"40%\">".$cliente->getEmail()."</td>";
                                echo "<td width=\"20%\">";
                                    echo "<a href='lista_clientes.php?id=".$cliente->getId()."' class='btn btn-light' title='Excluir' alt='Excluir'>
                                            <img src='../svg/si-glyph-delete.svg' width='16' height='16'></a>";
                                    echo "<a href='detalhe_cliente.php?id=".$cliente->getId()."' class='btn btn-light' title='Detalhes' alt='Detalhes'>
                                            <img src='../svg/si-glyph-badge-name.svg' width='16' height='16'></a>";
                                    echo "<a href='cad_cliente.php?id=".$cliente->getId()."' class='btn btn-light' title='Editar' alt='Editar'>
