...
if(isset($_GET['id'])){
    ControllerCategoria::excluir($_GET['id']);
    header('Location: lista_categorias.php');
}

$lista = ControllerCategoria::buscarTodos();
?>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col2">
                    <a href="cad_categoria.php" class="btn btn-success">Novo</a>
                </div>
                <br>
                <table class="table table-hover">
                    ...
                    foreach ($lista as $categoria){
                        echo "<tr>";
                        echo "<td width=\"80%\">".utf8_decode($categoria->getDescricao())."</td>";
                        echo "<td width=\"20%\">";
                        echo "<a href='lista_categorias.php?id=".$categoria->getId()."' class='btn btn-light' title='Excluir' alt='Excluir'>
                                            <img src='../svg/si-glyph-delete.svg' width='16' height='16'></a>";
                        echo "<a href='cad_categoria.php?id=".$categoria->getId()."' class='btn btn-light' title='Editar' alt='Editar'>
