...
$txtNome    = "Renato";
$txtAssunto    = "Teste de Email";
$txtEmail    = "renato.abreu@ifg.edu.br";
$txtMensagem    = "Essa é a mensagem";
...
define('GUSER', 'renato.abreu.info@gmail.com');
define('GPWD', '');
...
if (smtpmailer($txtEmail, 'SEU-EMAIL-AQUI@gmail.com', $txtNome, $txtAssunto, $corpoMensagem)) {
